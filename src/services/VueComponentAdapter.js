...
export default class VueComponentAdapter {
    ...
    constructor(componentDescriptor, components) {
        ...
        Object.defineProperty(this, 'mounted', { configurable: false, enumerable: true, value: function() {
            /**
             * @type {any}
             */
        ...
        Object.defineProperty(this, 'destroyed', { configurable: false, enumerable: true, value: function() {
            /**
             * @type {any}
             */
            const vueComponent = this;
    ...
    getComputed() {
        ...
        this.#componentDescriptor.computed
            .forEach(method => {
                ...
                return computed[method] = descriptor ? descriptor.get : undefined;
            });
        return computed;
    }
